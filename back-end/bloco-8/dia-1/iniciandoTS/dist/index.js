...
console.log("CONTAS DE TEST:");
console.log(` D = 32cm e d = 18cm: ${Ex.losangleArea(32, 18)}`);
console.log(`D = 200cm e d = 50cm: ${Ex.losangleArea(200, 50)}`);
console.log(`D = 75cm e d = 25cm: ${Ex.losangleArea(75, 25)}`);
