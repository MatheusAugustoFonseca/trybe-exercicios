...
const sum = ((...num)=> num.reduce(((acc, val)=>{
  return acc + val;
}), 0));
// console.log(sum(2, 2, 3));

// const soma = ((...soma)=>soma.reduce(((acc, val) =>{
...
//4🚀 4 - Escreva uma função filterPeople que, dada uma lista de pessoas, retorna todas as pessoas australianas que nasceram no século 20:
const people = [
  {
    name: 'Nicole',
    bornIn: 1992,
